package com.example.intent_java_vazifa4;
...
import com.example.intent_java_vazifa4.user.Member;
import com.example.intent_java_vazifa4.user.User;
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult member) {
                    if(member.getResultCode() == Activity.RESULT_OK){
                        ...
                        Member member1 = (Member) data.getSerializableExtra("member");
